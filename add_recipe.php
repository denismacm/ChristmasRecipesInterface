...
<html lang="en">
    <head>
        <title>Add Recipe Form | Christmas Recipes</title>
    ...
    <body>
        ...
        <div id="container<?php if (!isset($error)) echo '-long';?>">
            <div id="center-box">
                <div class="title">
                    Add your very own Christmas recipe to share to the world! (*=Required)
                </div>
                <?php if (!isset($error)) : ?>
                    <br>
                    <form id="add-form" action="add_confirmation.php" method="POST">
                        ...
                        <input type="text" id="recipe_name" name="recipe_name" placeholder="e.g. cookies, pies, etc." value="">
                        ...
                        <input type="text" id="recipe_url" name="recipe_url" placeholder="e.g. bbcgoodfood.com, etc." value="">

                        <label for="image_url">Enter an image URL for your recipe: (max 200 char)</label>
                        <input type="text" id="image_url" name="image_url" placeholder="e.g. images.google.com, etc." value="">

                        <label for="description">Enter a description about your recipe: (max 1000 char)</label>
                        <input type="text" id="description" name="description" placeholder="e.g. This recipe is perfect for..." value="">
                        ...
                        <input id="submit-btn" type="submit" value="Add it!">
                    </form> <!-- #add-form-->
                <?php endif; ?>
            </div> <!-- #center-box -->
        </div> <!-- #container -->
