<?php
    ...
    !isset($_POST['recipe_name']) || trim($_POST['recipe_name']) == '' ||
                ...
                <?php if (isset($error)) : ?>
                    <form action="edit_recipe.php" method="GET">
                        <?php if (isset($_POST['recipe_id'])) :?>
                            <input type="hidden" name="recipe_id" value="<?php echo $_POST['recipe_id'];?>">
                        <?php endif;?>
                        <input id="edit-recipe" type="submit" value="Go back to recipe edit form">
                    </form>
                <?php else : ?>
                    <form action="recipe_details.php" method="GET">
                        <?php if (isset($_POST['recipe_id'])) :?>
                            <input type="hidden" name="recipe_id" value="<?php echo $_POST['recipe_id'];?>">
                        <?php endif;?>
                        <input id="edit-recipe" type="submit" value="Go back to recipe details">
                    </form>
                <?php endif; ?>
            </div> <!-- #center-box -->
        </div> <!-- #container -->
